...
class MaintenanceTicket(models.Model):
    ...
    ticket_head = models.ForeignKey(Ticket, related_name='maintenance_ticket', on_delete=models.CASCADE)
...
class SupportTicket(models.Model):
    ...
    ticket_head = models.ForeignKey(Ticket, related_name='support_ticket', on_delete=models.CASCADE)
